...
import * as dmrContract from "@grassroots/contracts/erc20-demurrage-token/contract";
...
import type { CreateVoucherSchema } from "@grassroots/validators/vouchers";
...
export const useVoucherDeploy = (
  ...
  const deploy = useCallback(
    async (input: Omit<CreateVoucherSchema, "voucherAddress">) => {

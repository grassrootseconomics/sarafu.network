...
import type { TLinkElement, TSelection } from 'platejs';
...
export function LinkFloatingToolbar({
  ...
  const activeCommentId = usePluginOption({ key: KEYS.comment }, 'activeId') as string;
...
function LinkOpenButton() {
  ...
  const selection = useEditorSelection() as TSelection;

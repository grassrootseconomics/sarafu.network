...
export function PoolTabs({
  ...
  const tabOptions = [
    { value: "reports", label: tNav("reports"), icon: Icons.reports },
    { value: "vouchers", label: tNav("vouchers"), icon: Icons.vouchers },
    { value: "transactions", label: t("transactions"), icon: ArrowLeftRightIcon },
    { value: "info", label: t("analytics"), icon: BarChart3Icon },
  ];

  const settingsTab = { value: "edit", label: t("settings") };
                  ...
                  {activeTab === "edit" ? (
                    ...
                    (() => {
                      ...
                      const descriptions = {
                        ...
                        vouchers: t("browseVouchers"),
                        transactions: t("transactionHistory"),
                        info: t("poolAnalyticsData"),
                      };
                      return (
                        <>
                          <div className="flex items-center justify-center w-8 h-8 bg-blue-200 rounded-full">
